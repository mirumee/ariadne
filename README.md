...
Ariadne is Python library for creating [GraphQL APIs](http://graphql.github.io/) that avoids high levels of abstraction and enables you to use existing GraphQL learning resources in your work.
