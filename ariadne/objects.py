...
class QueryType(ObjectType):
    """A convenience class for defining Query type.

    # Example

    Both of those code samples have the same effect:
...
class MutationType(ObjectType):
    """A convenience class for defining Mutation type.

    # Example

    Both of those code samples have the same result:
