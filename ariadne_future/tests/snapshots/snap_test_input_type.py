...
snapshots['test_input_type_raises_error_when_defined_with_invalid_graphql_type_schema 1'] = GenericRepr('<ExceptionInfo ValueError("UserInput class was defined with __schema__ containing GraphQL definition for \'ObjectTypeDefinitionNode\' (expected \'type\')") tblen=3>')
...
snapshots['test_input_type_raises_error_when_defined_without_extended_dependency 1'] = GenericRepr('<ExceptionInfo ValueError("ExtendUserInput class was defined without required GraphQL input definition for \'User\' in __requires__") tblen=3>')

snapshots['test_input_type_raises_error_when_defined_without_field_type_dependency 1'] = GenericRepr('<ExceptionInfo ValueError("UserInput class was defined without required GraphQL type definition for \'Role\' in __requires__") tblen=3>')
...
snapshots['test_input_type_raises_error_when_defined_without_schema 1'] = GenericRepr("<ExceptionInfo TypeError('UserInput class was defined without required __schema__ attribute') tblen=3>")
