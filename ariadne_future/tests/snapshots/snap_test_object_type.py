...
snapshots['test_object_type_raises_error_when_defined_with_invalid_graphql_type_schema 1'] = GenericRepr('<ExceptionInfo ValueError("UserType class was defined with __schema__ containing GraphQL definition for \'ScalarTypeDefinitionNode\' (expected \'type\')") tblen=3>')
