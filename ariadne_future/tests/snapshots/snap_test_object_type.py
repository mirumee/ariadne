...
snapshots['test_object_type_raises_error_when_defined_with_alias_for_nonexisting_field 1'] = GenericRepr("<ExceptionInfo ValueError('ExtendUserType class was defined with aliases for fields not in GraphQL type: joinedDate') tblen=3>")
...
snapshots['test_object_type_raises_error_when_defined_with_resolver_for_nonexisting_field 1'] = GenericRepr("<ExceptionInfo ValueError('ExtendUserType class was defined with resolvers for fields not in GraphQL type: resolve_group') tblen=3>")
