...
snapshots['test_scalar_type_raises_error_when_defined_with_invalid_graphql_type_schema 1'] = GenericRepr('<ExceptionInfo ValueError("DateScalar class was defined with __schema__ containing invalid GraphQL type definition for \'ObjectTypeDefinitionNode\' (expected \'scalar\')") tblen=3>')
