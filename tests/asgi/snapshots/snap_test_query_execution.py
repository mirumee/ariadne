...
snapshots[
    "test_attempt_execute_complex_query_without_variables_returns_error_json 1"
] = {
    "data": None,
    "errors": [
        {
...
snapshots[
    "test_attempt_execute_query_with_invalid_operation_name_string_returns_error_json 1"
] = {
    "data": None,
    "errors": [
        {
...
snapshots[
    "test_attempt_execute_query_with_invalid_operation_name_type_returns_error_json 1"
] = {"errors": [{"message": '"[1, 2, 3]" is not a valid operation name.'}]}

snapshots["test_attempt_execute_query_with_invalid_variables_returns_error_json 1"] = {
    "errors": [{"message": "Query variables must be a null or an object."}]
}
...
snapshots[
    "test_attempt_execute_subscription_with_invalid_query_returns_error_json 1"
] = {
...
snapshots[
    "test_query_is_executed_for_multipart_request_with_large_file_with_tracing 1"
] = {"data": {"upload": "UploadFile"}}

snapshots["test_query_is_executed_for_post_json_request 1"] = {"data": {"status": True}}
